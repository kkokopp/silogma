...
<div class="py-4">
    <div class="relative px-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex min-h-full flex-col">
            <div class="flex p-5">
                <a href="{{ route('admin.senjata.tambah') }}" class="flex gap-2 justify-center items-center hover:bg-green-600 rounded-lg bg-green-500 py-2 px-4 text-white font-semibold">
                        ...
                        @foreach ($alutsistas as $alutsista)                            
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                @if ($alutsista->status_senjata->nama_status_senjata == 'Aktif')                                    
                                    <td class="px-6 py-4">
                                        <div class="bg-green-300 border-2 border-green-400 rounded-lg flex w-fit justify-center items-center font-bold text-green-600 py-2 px-5">
                                            <p>
                                ...
                                <td class="px-6 py-4">
<!-- Dropdown Button -->
                                    <button type="button" class="text-gray-700 hover:text-gray-900 focus:outline-none dropdown-button" id="button-menu">
