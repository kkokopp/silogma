                        ...
                        <div class="flex flex-col w-1/2">
                            <div class=" pb-5 flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nama_senjata" class="block mt-1 w-full" type="text" name="nama_senjata" :value="old('nama_senjata')" required autofocus autocomplete="nama_senjata" />
                                    <x-input-error :messages="$errors->get('nama_senjata')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="nomor_seri" :value="__('Nomor Seri')" />
                                    <x-text-input id="nomor_seri" class="block mt-1 w-full" type="text" name="nomor_seri" :value="old('nomor_seri')" required autofocus autocomplete="nomor_seri" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="jumlah" class="block mt-1 w-full" type="number" name="jumlah" :value="old('jumlah')" required autofocus autocomplete="jumlah" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="keterangan" class="block mt-1 w-full" type="hidden" name="keterangan" :value="old('keterangan')" required autofocus autocomplete="keterangan" />
                            ...
                            <div id="riwSec" class="border-t-2 border-dashed pt-5 border-gray-400 pb-5">                                
                                ...
                                <div id="riwayatContainer" class="relative py-3 border-b-gray-400 border-b-2">
                                    ...
                                    <div id="riwayatForm" class="riwayat-form dropdown-form flex flex-col gap-4 open pt-5">
                                        <div>
                                            <x-input-label for="nama_operasi" :value="__('Nama Operasi')" />
                                            <x-text-input id="nama_operasi" class="block mt-1 w-full" type="text" name="riwayat[0][nama_operasi]" :value="old('nama_operasi')" required autofocus autocomplete="nama_operasi" />
                                            <x-input-error :messages="$errors->get('nama_operasi')" class="mt-2" />
                                        </div>
                                        <div>
                                            <x-input-label for="lokasi_operasi" :value="__('Lokasi Operasi')" />
                                            <x-text-input id="lokasi_operasi" class="block mt-1 w-full" type="text" name="riwayat[0][lokasi_operasi]" :value="old('lokasi_operasi')" required autofocus autocomplete="lokasi_operasi" />
                                    ...
                                    <button id="toggleForm" class="absolute top-2 right-2 z-50 bg-gray-200 border-2 border-gray-400 px-1 py-1 rounded-full" type="button">
                                        <svg id="arrow-bottom" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                        </svg>
                                        
                                        <svg id="arrow-left" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hidden">
