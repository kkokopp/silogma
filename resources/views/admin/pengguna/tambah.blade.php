                        ...
                        <div class="flex flex-col w-1/2">
                            <div class=" pb-5 flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nomor_induk" class="block mt-1 w-full" type="number" name="nomor_induk" :value="old('nomor_induk')" required autofocus autocomplete="nomor_induk" />
                                    <x-input-error :messages="$errors->get('nomor_induk')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="nomor_tlp" :value="__('Nomor HP')" />
                                    <x-text-input id="nomor_tlp" class="block mt-1 w-full" type="number" name="nomor_tlp" :value="old('nomor_tlp')" required autofocus autocomplete="nomor_tlp" />
