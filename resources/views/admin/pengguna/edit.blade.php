    ...
    <div class="px-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <form action="{{ route('admin.pengguna.update', ['user' => $user->kode_user]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                        ...
                        <div class="flex flex-col w-1/2">
                            <div class=" pb-5 flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="roles" name="roles" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-gray-500 dark:focus:border-gray-600 focus:ring-gray-500 dark:focus:ring-dark-600 rounded-md shadow-sm block mt-1 w-full">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nomor_induk" class="block mt-1 w-full" type="number" name="nomor_induk" :value="$user->nomor_induk" required autofocus autocomplete="nomor_induk" />
                                    <x-input-error :messages="$errors->get('nomor_induk')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="nomor_tlp" :value="__('Nomor HP')" />
                                    <x-text-input id="nomor_tlp" class="block mt-1 w-full" type="number" name="nomor_tlp" :value="$user->nomor_tlp" required autofocus autocomplete="nomor_tlp" />
