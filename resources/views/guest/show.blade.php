                                ...
                                <div class="flex justify-center items-center">
                                    @if ($alutsista->foto == null)
                                        @if ($alutsista->jenis_senjata->id >= 1 && $alutsista->jenis_senjata->id <= 6)
                                            <img src="{{ asset('images/' . $jenis_gambar[$alutsista->jenis_senjata->id - 1]) }}" alt="beranda" class="object-cover object-top w-full rounded-t-md">
                                        @endif
                                    @else
                                        ...
                                        @foreach ($alutsistas_last as $alutsistas)                                    
                                            <div class="rounded-md border-slate-400 h-42 border-2 group hover:-translate-x-1 hover:-translate-y-1 transition-transform duration-300 hover:scale-105 hover:shadow-md flex flex-col">
                                                <div class="overflow-hidden">
                                                    @if ($alutsistas->foto == null)
                                                        @if ($alutsistas->jenis_senjata->id >= 1 && $alutsistas->jenis_senjata->id <= 6)
                                                            <img src="{{ asset('images/' . $jenis_gambar[$alutsistas->jenis_senjata->id - 1]) }}" alt="beranda" class="object-cover object-top w-full rounded-t-md h-28">
                                                        @endif
                                                    @else
